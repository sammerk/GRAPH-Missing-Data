---
title: "Wdh: Einfache lineare Regression"
format:
  live-html:
    css: 
      - exams/webex.css
...
![Abhängingkeit der Regressionsgewichte $b_0$ und $b_1$ von der Maßeinheit sowie Standardisierte Regression (rechts)](img/reg-abh-masseinheit.svg){#fig-standardized-regression width="100%" fig-align="left"}
